...
function Profile() {
  ...
  return (
    <Center flexDirection="column" mt={60} mb={0} textAlign="center">
  ...
  <VStack mt={0} width="100%" >
    ...
    {comments.length > 0 ? (
      ...
      <Text 
        ...
        mb={0}
        fontSize="16px" 
        fontWeight="bold">{`${comment.User?.name}`}</Text>
      <Text
        mt={0}
        mb={0}
        width={150}
        ...
        color="gray.500"
      >
            Оставил коментарий к: <Text fontWeight="bold" as="span">{comment.Tea?.name}</Text>
            </Text>
          </Stack>
